...
const Routers = function ({ history, app }) {
  ...
  const routes = [
    ...
    , {
      path: '/genre',
      models: () => [import('./models/genre')],
      component: () => import('./routes/genre/'),
    },
    {
      path: '/genre/:id',
      models: () => [import('./models/genre/detail')],
      component: () => import('./routes/genre/detail/'),
    } 
    , {
      path: '/type',
      models: () => [import('./models/type')],
      component: () => import('./routes/type/'),
    },
    {
      path: '/type/:id',
      models: () => [import('./models/type/detail')],
      component: () => import('./routes/type/detail/'),
    } 
    ,
    {
      path: '/login',
